...
**Técnico em Informática · Colégio São Paulo da Cruz** *(fev/2025 – atual)*
- Suporte técnico a 750 usuários e manutenção de 40 estações
...
- 🎓 **Bacharelado em Engenharia de Software** — PUC Minas *(conclusão prevista: Jun/2028)*
- ☁️ **Práticas de Cloud Services com Swift** — Instituto Eldorado, 50h *(2025)*
- 🍎 **Algoritmos e POO com Swift** — Instituto Eldorado, 50h *(2025)*
- 💡 **Fundamentos de Lógica de Programação** — Fundação Bradesco, 15h *(2023)*
